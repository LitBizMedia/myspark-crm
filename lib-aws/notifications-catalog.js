...
const CATALOG = [
  ...
  { key: 'recurring_billing_enrollment', scope: 'subaccount', audience: 'patient', category: 'Recurring Billing', channels: ['email', 'sms'], default_email: true, default_sms: false, default_timing_minutes_before: null, status: 'live', template_type: 'recurring-enrollment', label: 'Enrollment Confirmation', description: 'Welcome message when a patient enrolls in recurring billing' },
  { key: 'recurring_billing_upcoming_charge', scope: 'subaccount', audience: 'patient', category: 'Recurring Billing', channels: ['email', 'sms'], default_email: true, default_sms: false, default_timing_minutes_before: 4320, status: 'live', template_type: 'recurring-upcoming', label: 'Upcoming Charge Reminder', description: 'Reminds a patient before their card will be charged' },
  { key: 'recurring_billing_payment_failed', scope: 'subaccount', audience: 'patient', category: 'Recurring Billing', channels: ['email', 'sms'], default_email: true, default_sms: false, default_timing_minutes_before: null, status: 'live', template_type: 'recurring-failed', label: 'Recurring Charge Failed', description: 'Alerts a patient when their recurring charge fails' },
  { key: 'recurring_billing_suspended', scope: 'subaccount', audience: 'patient', category: 'Recurring Billing', channels: ['email', 'sms'], default_email: true, default_sms: false, default_timing_minutes_before: null, status: 'live', template_type: 'recurring-suspended', label: 'Recurring Billing Suspended', description: 'Notifies a patient when their recurring billing is suspended due to failed payments' },
  { key: 'recurring_billing_paused', scope: 'subaccount', audience: 'patient', category: 'Recurring Billing', channels: ['email', 'sms'], default_email: true, default_sms: false, default_timing_minutes_before: null, status: 'live', template_type: 'recurring-paused', label: 'Recurring Billing Paused', description: 'Notifies a patient that their recurring billing has been paused' },
  { key: 'recurring_billing_resumed', scope: 'subaccount', audience: 'patient', category: 'Recurring Billing', channels: ['email', 'sms'], default_email: true, default_sms: false, default_timing_minutes_before: null, status: 'live', template_type: 'recurring-resumed', label: 'Recurring Billing Resumed', description: 'Notifies a patient when their recurring billing resumes' },
  { key: 'recurring_billing_cancelled', scope: 'subaccount', audience: 'patient', category: 'Recurring Billing', channels: ['email', 'sms'], default_email: true, default_sms: false, default_timing_minutes_before: null, status: 'live', template_type: 'recurring-cancelled', label: 'Recurring Billing Cancelled', description: 'Confirms to a patient that their recurring billing has been cancelled' },
