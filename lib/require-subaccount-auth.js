...
const { parseSessionCookie, validateSession } = require('./subaccount-auth');
...
// Same idea, for agency endpoints. Currently agency sessions still use the
// old localStorage approach so this is a stub that other endpoints can opt
// into when agency-side server sessions are built. For now, this checks the
// session cookie and verifies user_type === 'agency'.
