// POST /api/subaccount/contact-allergy-delete
...
async function handler(req, res) {
  ...
  try {
    ...
    const r = await db.query(
      `DELETE FROM contact_allergies WHERE id = $1 AND subaccount_id = $2 RETURNING id, contact_id`,
    ...
    await logAudit({
      ...
      action: 'subaccount.contact_allergy.delete',
    ...
    console.error('contact-allergy-delete error:', e.message);
