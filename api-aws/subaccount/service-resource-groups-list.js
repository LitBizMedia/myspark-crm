// POST /api/subaccount/service-resource-groups-list
// Body: { service_id }
// Returns groups for a service, each with its resource_ids.
...
async function handler(req, res) {
  ...
  try {
    ...
    const membersRes = await db.query(
      `SELECT group_id, resource_id, display_order FROM service_resource_group_members
