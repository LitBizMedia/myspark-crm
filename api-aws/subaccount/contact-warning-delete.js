// POST /api/subaccount/contact-warning-delete
...
async function handler(req, res) {
  ...
  try {
    ...
    const r = await db.query(
      `DELETE FROM contact_warnings WHERE id = $1 AND subaccount_id = $2 RETURNING id, contact_id`,
    ...
    await logAudit({
      ...
      action: 'subaccount.contact_warning.delete',
    ...
    console.error('contact-warning-delete error:', e.message);
